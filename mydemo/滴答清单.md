...
|Type|Name|Description|Schema|
|---|---|---|---|
|**Path**|**focusId** _required_|Focus identifier|string|
|**Query**|**type** _required_|Focus type  <br>**Value** : Pomodoro: `0`, Timing: `1`|integer (int32)|
...
|**Type**|**Name**|**Description**|**Schema**|
|---|---|---|---|
|**Query**|**from** _required_|Range start time in `"yyyy-MM-dd'T'HH:mm:ssZ"` format  <br>**Example** : `"2026-04-01T00:00:00+0800"`|string (date-time)|
|**Query**|**to** _required_|Range end time in `"yyyy-MM-dd'T'HH:mm:ssZ"` format  <br>**Example** : `"2026-04-02T00:00:00+0800"`|string (date-time)|
|**Query**|**type** _required_|Focus type  <br>**Value** : Pomodoro: `0`, Timing: `1`|integer (int32)|
...
|Type|Name|Description|Schema|
|---|---|---|---|
|**Path**|**habitId** _required_|Habit identifier|string|
...
|**Type**|**Name**|**Description**|**Schema**|
|---|---|---|---|
|**Body**|name _required_|Habit name. Maximum length is 1000 characters|string|
...
|---|---|---|---|
|**Path**|**habitId** _required_|Habit identifier|string|
|**Body**|stamp _required_|Date stamp in `YYYYMMDD` format  <br>**Example** : `20260407`|integer (int32)|
...
|**Type**|**Name**|**Description**|**Schema**|
|---|---|---|---|
|**Query**|**habitIds** _required_|Habit identifiers, separated by commas  <br>**Example** : `habit-1,habit-2`|string|
|**Query**|**from** _required_|Start date stamp in `YYYYMMDD` format  <br>**Example** : `20260401`|integer (int32)|
|**Query**|**to** _required_|End date stamp in `YYYYMMDD` format  <br>**Example** : `20260407`|integer (int32)|
...
|**tasks**|Related task briefs|< OpenPomodoroTaskBrief > array|
...
|**checkins**|Check-in entries|< OpenHabitCheckinData > array|
